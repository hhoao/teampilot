...
- [x] **Step 3: Implement prefs + cubit**
...
- [x] **Step 1: Make `HomeSidebar` width-agnostic**
...
- [x] **Step 2: Replace `HomePage` Row with `TwoPaneSplitView`**
...
- [x] **Step 1: Manual checklist (or note for human)**
...
- [x] **Step 2: Final commit only if Task 3 produced code fixes** (skip if clean)
