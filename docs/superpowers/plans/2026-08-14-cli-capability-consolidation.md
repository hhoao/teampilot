...
- [ ] **Step 14a: 提取 provider/home 材料化 → ProviderCapability.materializeSessionHome**
...
- [ ] **Step 14b: 提取 managed hooks → 共享 ManagedHookProvisioner**
...
- [ ] **Step 14c: prompt 步骤接 PromptHubService**
...
- [ ] **Step 14d: 删除 ConfigProfileCapability,收编会话编排**
