...
|-------|---------|----------|
| `selection_height_style.patch` | `DefaultSelectionStyle.selectionHeightStyle` so `SelectionArea` can paint full line spacing | [flutter#161010](https://github.com/flutter/flutter/issues/161010) |
