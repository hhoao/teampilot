...
| [docs/CODE_QUALITY.md](docs/CODE_QUALITY.md) / [CODE_QUALITY.en.md](docs/CODE_QUALITY.en.md) | File size, layering, tests, Extension conventions |
...
| Extensions (install, state, provision) | `client/lib/services/extension/`, `extension_repository.dart`, `extension_cubit.dart` |
