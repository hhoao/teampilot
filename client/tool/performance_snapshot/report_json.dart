...
extension PerformanceAnalysisResultJson on PerformanceAnalysisResult {
  Map<String, Object?> toJsonMap() => {
    ...
    if (appliedFilters.isNotEmpty)
      'filtersNote': 'filters applied to timeline slices',
    'meta': _metaJson(),
    ...
    if (frameDrilldown != null)
      'frameDrilldown': _drilldownJson(frameDrilldown!),
  ...
  Map<String, Object?> _timelineJson(TimelineAnalysis timeline) => {
    ...
    'topSlices': [
      for (final s in timeline.topSlices)
        {'durationMs': s.durationMs, 'track': s.trackLabel, 'name': s.name},
    ],
    'aggregatedSlices': [
  ...
  Map<String, Object?> _precisionJson(PrecisionAnalysis p) => {
    ...
    if (p.traceCoverage != null)
      'traceCoverage': _traceCoverageJson(p.traceCoverage!),
  };
