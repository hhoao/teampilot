...
/// Persists the set of favorited member-hub keys at `member-hub/favorites.json`.
class ExpertHubFavoritesStore {
  ExpertHubFavoritesStore({Filesystem? fs, String? pathOverride})
    : _fsOverride = fs,
  ...
  String get _path =>
      _pathOverride ?? AppStorage.paths.memberHubFavoritesJson;
