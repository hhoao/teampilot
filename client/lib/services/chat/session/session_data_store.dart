...
import '../../../models/team_config.dart'
    show CliTool, TeamMemberConfig, TeamProfile;
...
export '../../catalog/workspace_catalog.dart' show ChatDataSnapshot;
...
class SessionDataStore {
  ...
  ChatDataSnapshot appendSession(ChatDataSnapshot base, AppSession session) {
    markSessionDocument(session.sessionId);
    final alreadyPresent = base.sessions.any(
  ...
  createWorkspaceWithFirstSession(
    ...
    final workspace = await repo.createWorkspace(folders, display: display);
