...
import '../team_bus/mcp/teammate_bus_session_registry.dart';
...
class ChatTab {
  ...
  /// mixed 模式：本 team 会话的进程内总线与其 gateway 注册（随 tab 建/销）。
  TeamBus? teamBus;
  TeammateBusSessionRegistration? busSessionRegistration;
