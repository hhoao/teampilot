...
import '../../runtime/pty/member_turn_interrupt_service.dart';
...
final class AskUserQuestionAnswerService {
  ...
  bool _completeHookAllow({
    ...
    return gate.complete(
      ...
      memberId: memberId,
      toolUseId: toolUseId,
      reply: AskUserQuestionHookReply.allow(questions: questions, answers: map),
    );
  }
  ...
  Future<AskUserAnswerResult> _answerPty({
    ...
    final indices =
        optionIndices ?? (optionIndex == null ? null : <int>[optionIndex]);
  ...
  AskUserAnswerResult _answerPending({
    ...
    _store.put(
      sessionId: sessionId,
      memberId: memberId,
      entry: AskUserAnswerPendingEntry(requestId: requestId, answers: answers),
    );
    return const AskUserAnswerOk();
  }
