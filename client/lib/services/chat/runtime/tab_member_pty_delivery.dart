...
import '../team_bus/mailbox_delivery.dart';
...
import '../terminal/fullscreen_pty_automation.dart';
import '../terminal/member_pty_inject_service.dart';
...
import '../terminal/terminal_fullscreen_pty_port.dart';
...
final class TabMemberPtyDelivery {
  ...
  Future<PromptDeliverySubmission> deliverTrackedUserCommandToMember(
    ...
    return PromptDeliverySubmission(
      ...
      state: switch (result) {
        ...
        PromptSubmissionResult.dropped || PromptSubmissionResult.unconfirmed =>
  ...
  FullscreenCrAckConfig _crAckForMember(String sessionId, String memberId) {
    ...
    return FullscreenCrAckConfig(
      ...
      pasteZoneBottomPad: behavior?.pasteZoneBottomPad ?? 0,
    );
  }
