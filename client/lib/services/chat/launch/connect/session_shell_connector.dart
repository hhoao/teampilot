...
import '../../../agent_status/member_agent_status_endpoint_resolver.dart';
...
class SessionShellConnector {
  SessionShellConnector(
    this._host,
    this._delegate, {
    required SessionPersistenceWriter persister,
  ...
  /// Session-row / snapshot writes. Owned by the session domain, not the
  /// connector — see [SessionPersistenceWriter].
  final SessionPersistenceWriter _persister;
