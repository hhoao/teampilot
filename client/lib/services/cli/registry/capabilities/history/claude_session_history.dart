...
/// Claude Code JSONL history under `{root}/projects/{bucket}/{taskId}.jsonl`.
///
/// Event shapes align with Claude Code transcript lines (`type` + `message`
/// with string or content-block array: `text`, `tool_use`, `tool_result`).
final class ClaudeSessionHistory implements SessionHistoryCapability {
