...
/// Cursor tool-call resolvers.
///
/// Cursor uses the same tool naming conventions as Claude Code but also
/// supports `execute` as a shell / terminal tool name.
class CursorToolCallResolvers implements ToolCallResolversCapability {
