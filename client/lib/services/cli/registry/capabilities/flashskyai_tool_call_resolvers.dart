...
/// flashskyai tool-call resolvers.
///
/// flashskyai is CLII-compatible with Claude Code and uses the same
/// snake_case argument key conventions.
class FlashskyaiToolCallResolvers implements ToolCallResolversCapability {
  const FlashskyaiToolCallResolvers();
