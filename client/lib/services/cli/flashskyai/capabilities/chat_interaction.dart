...
/// PTY picker answer flow — flashskyai surfaces AskUserQuestion through the
...
final class FlashskyaiChatInteraction
    implements ChatInteractionCapability, RuntimeEventCapability {
  const FlashskyaiChatInteraction();
  ...
  List<HookEntry> managedHookEntries(RuntimeEventHookContext context) =>
      managedRuntimeEventHookEntries(cli: CliTool.flashskyai, context: context);
