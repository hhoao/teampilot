...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get gitUnversionedFiles => '未暂存的文件';

  @override
  String get gitChanges => '要提交的变更';
  ...
  @override
  String get workspaceChatLandingCustomLaunch => '自定义…';
  ...
  @override
  String get injectSessionSshMcpTitle => '注入 Session SSH MCP';

  @override
  String get injectSessionSshMcpSubtitle =>
      '本机和远程座位都可通过 MCP 在本工作区的 SSH 机器上执行命令和传文件。更改后需重连 session。';
