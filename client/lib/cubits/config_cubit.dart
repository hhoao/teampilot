...
enum ConfigSection { layout, appearance, session, cli, about, logs }
...
class ConfigState extends Equatable {
  ...
  String get title => switch (section) {
    ...
    ConfigSection.appearance => 'Appearance Configuration',
  ...
  String get breadcrumb => switch (section) {
    ...
    ConfigSection.appearance => 'Config / Appearance',
