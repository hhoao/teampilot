...
/// Painted row height (padding + min content), excluding the inter-row gap.
...
/// Vertical gap between session tiles (outside the painted hover/selection).
const double kWorkspaceSidebarRowGap = 2;
