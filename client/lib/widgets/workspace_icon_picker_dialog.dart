...
class _WorkspaceIconPickerDialogState
    extends State<_WorkspaceIconPickerDialog> {
              ...
              children: [
                ...
                ActionChip(
                  ...
                  onPressed: () => Navigator.of(
                    context,
                  ).pop(const WorkspaceIconPickerUploadRequested()),
                ),
              ],
            ),
          ),
          ...
          TpDialogActions(
            children: [
              TextButton(
                onPressed: () => Navigator.of(
                  context,
                ).pop(const WorkspaceIconPickerCancelled()),
                child: Text(widget.cancelLabel),
              ),
              FilledButton(
                onPressed: () => Navigator.of(
                  context,
                ).pop(WorkspaceIconPickerCommitted(_draftIcon)),
