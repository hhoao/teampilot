...
///
/// Used while scrolling so text/click cursors do not flicker as content moves
/// under a stationary pointer (chat history, markdown preview, …).
class ScrollCursorLock extends SingleChildRenderObjectWidget {
  const ScrollCursorLock({
  ...
  RenderObject createRenderObject(BuildContext context) {
    return RenderScrollCursorLock(active: active);
  }

  @override
  void updateRenderObject(
    BuildContext context,
    RenderScrollCursorLock renderObject,
  ) {
    renderObject.active = active;
  }
}

class RenderScrollCursorLock extends RenderProxyBox
    implements MouseTrackerAnnotation {
  RenderScrollCursorLock({required bool active}) : _active = active;
