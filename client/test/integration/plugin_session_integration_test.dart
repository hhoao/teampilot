...
void main() {
  ...
  test(
    'marketplace plugin reaches the session with native registration',
    () async {
      ...
      expect(
        Directory(
          p.join(pluginsDir, 'acme__demo-marketplace__demo'),
        ).existsSync(),
        isTrue,
      ...
      expect(
        Directory(
          p.join(pluginsDir, 'marketplaces', 'demo-marketplace'),
        ).existsSync(),
        isTrue,
      ...
      final known =
          jsonDecode(
                File(
                  p.join(pluginsDir, 'known_marketplaces.json'),
                ).readAsStringSync(),
              )
              as Map;
