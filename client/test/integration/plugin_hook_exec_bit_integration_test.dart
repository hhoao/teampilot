...
void main() {
  ...
  test(
    'executable hook scripts keep their +x bit after session materialization',
    () async {
      ...
      // ignore: avoid_print
      print(
        'SRC_MODE src=${(srcMode & 0x1FF).toRadixString(8)} '
        'exec=${(srcMode & 0x49) != 0}',
      );
      ...
      const marketplaceCache =
          'plugins/marketplace-cache/acme/demo-marketplace@main';
      ...
      expect(
        ...
        isNot(equals(0)),
        reason:
            'hook script must keep its executable bit after materialization',
      );
    },
  );
}
