...
void main() {
  ...
  ManagedProvider secretEntry() => ManagedProvider(
    id: 'm1',
    name: 'Entry m1',
    ...
    return MaterialApp(
      ...
      home: CliToolRegistryScope(
        ...
        child: MultiBlocProvider(
          ...
          child: Scaffold(
            body: SizedBox(width: 1000, height: 1400, child: form),
          ),
        ),
      ),
    );
  ...
  testWidgets(
    'linking a managed entry hides the apiKey input and drafts the link',
    (tester) async {
      ...
      await tester.tap(
        find.byKey(const ValueKey('app-provider-preset-claude')),
      );
      await tester.pumpAndSettle();
      ...
      expect(
        find.text(l10n.appProviderCredentialLinkedTo('Entry m1')),
        findsOneWidget,
      );
