...
void main() {
  ...
  test('foldersForPrimaryPath reorders workspace folders', () {
    ...
    final reordered = Workspace.foldersForPrimaryPath(
      folders,
      '/extra',
  ...
  test('foldersForPrimaryPath is no-op when primary path is empty', () {
    ...
    expect(
      Workspace.foldersForPrimaryPath(folders, '', usesPosixPaths: false),
      folders,
    );
  });
  ...
  test('foldersForPrimaryPath leaves list unchanged when primary is first', () {
    ...
    expect(
      Workspace.foldersForPrimaryPath(folders, '/main', usesPosixPaths: false),
      folders,
    );
  });
