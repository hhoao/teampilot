...
void main() {
  ...
  test('appends history and caps at 30', () async {
    ...
    // App pid 1 subtree: all three rows.
    const appMem = (1024 + 20480 + 4096) * 1024;
...
''';
  ...
  test('sums subtree for registered pid and includes host + app', () async {
    ...
    expect(snap.app?.cpu, 1.7); // 0 + 1.5 + 0.2
    expect(snap.app?.memoryBytes, (1024 + 20480 + 4096) * 1024);
    expect(snap.totalCpu, closeTo(1.7 + 1.7, 0.001));
    expect(
      snap.totalMemory,
      (1024 + 20480 + 4096) * 1024 + (20480 + 4096) * 1024,
    );
  });
}
