...
void main() {
  group('shouldSkipReinjectAfterCrStuck', () {
    test(
      'composerMovesDown skips only when empty, needle visible, not staged',
      () {
        expect(
    ...
    test(
      'composerMovesDown does not skip when needle still staged in composer',
      () {
        expect(
          shouldSkipReinjectAfterCrStuck(
            strategy: FullscreenCrAckStrategy.composerMovesDown,
    ...
    for (final case_ in [
      ...
      test('composerMovesDown does not skip empty=${case_.empty} '
          'needle=${case_.needle}', () {
        expect(
          shouldSkipReinjectAfterCrStuck(
            strategy: FullscreenCrAckStrategy.composerMovesDown,
