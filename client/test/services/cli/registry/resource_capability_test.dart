...
void main() {
  ...
  test(
    'every launchable CLI exposes a ResourceCapability supporting skills',
    () {
  ...
  test(
    ...
    () {
      ...
      expect(
        registry
            .capability<ResourceCapability>(CliTool.opencode)!
            .subdirFor(ResourceKind.skill),
        'skill',
      );
      expect(
        registry
            .capability<ResourceCapability>(CliTool.cursor)!
            .subdirFor(ResourceKind.skill),
        'skills-cursor',
      );
      for (final cli in CliTool.values.where(
        ...
        expect(
          registry
              .capability<ResourceCapability>(cli)!
              .subdirFor(ResourceKind.skill),
          'skills',
