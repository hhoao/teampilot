...
import 'package:teampilot/services/cli/registry/capabilities/history/flashskyai_session_history.dart';
...
void main() {
  ...
  setUp(() async {
    base = await Directory.systemTemp.createTemp('flashskyai_session_history_');
  });
  ...
  test('parses user assistant and collapses tools under workspaces', () async {
    ...
    await File(p.join(workspaces, 'task-1.jsonl')).writeAsString(fixture);

    final snap = await const FlashskyaiSessionHistory().loadHistory(
