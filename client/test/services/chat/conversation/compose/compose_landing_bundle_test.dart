...
import 'package:teampilot/services/chat/conversation/compose/compose_landing_bundle.dart';
...
void main() {
  ...
  group('slashBundleForLanding', () {
    ...
    test('Simple + empty expertKey uses default expert deps', () {
      ...
      final defaultMember = builtinExpertMembers().firstWhere(
        (m) => m.key == kBuiltinDefaultExpertKey,
      );
      expect(
        bundle.skillIds,
