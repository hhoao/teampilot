...
import 'package:teampilot/services/chat/conversation/compose/compose_trigger_chip_style.dart';

void main() {
  test(
    'buildComposeMirrorLayoutSpans paints token glyphs with palette color',
    () {
