...
import 'package:teampilot/services/chat/conversation/compose/compose_file_attach.dart';
import 'package:teampilot/services/chat/conversation/compose/compose_image_clipboard.dart';

import '../../../../support/in_memory_filesystem.dart';

class _FakeClipboardReader implements ComposeImageClipboardReader {
  _FakeClipboardReader({this.bytesPayload, this.filePaths = const []});
...
void main() {
  test(
    'pasteComposeImageAttachment imports clipboard bytes to Attachments',
    () async {
  ...
  test(
    'pasteComposeImageAttachment keeps original path for clipboard files',
    () async {
      final fs = InMemoryFilesystem();
      const root = '/repo';
