...
import 'package:teampilot/services/chat/conversation/compose/compose_trigger_insert.dart';
import 'package:teampilot/services/chat/conversation/compose/compose_trigger_query.dart';
  ...
  group('buildComposeSlashCandidates', () {
    test('includes only bundle-enabled skills and plugin commands', () {
      final candidates = buildComposeSlashCandidates(
        ...
        enabledBundle: const ConfigBundle(skillIds: ['s1'], pluginIds: ['p1']),
        query: 'brain',
      );
