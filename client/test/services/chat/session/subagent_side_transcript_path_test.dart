...
import 'package:teampilot/services/chat/conversation/history/subagent_side_transcript_path.dart';
...
void main() {
  ...
  test('windows-style parents keep backslash joins', () {
    ...
    expect(pathContextForTranscript(r'C:\a\b'), p.windows);
    expect(pathContextForTranscript('/projects/a'), p.posix);
  });
}
