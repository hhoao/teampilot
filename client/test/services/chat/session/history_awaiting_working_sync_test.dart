...
import 'package:teampilot/services/chat/conversation/history/history_awaiting_working_sync.dart';
...
void main() {
  group('resolveHistoryAwaitingWorkingAction', () {
    ...
    test('awaiting + idle without latch → grace clear '
    ...
    test('awaiting + connect / PTY-down defers — keep Starting, no grace', () {
    ...
    test('awaiting + PTY up but history continue still in flight → defer '
