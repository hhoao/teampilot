...
void main() {
  ...
  test(
    'forked simple claude session pins --resume to the source transcript',
    () async {
      ...
      await fs.ensureDir(
        fs.pathContext.join(sourceToolDir, 'projects', bucket),
      );
      ...
      expect(
        ...
        isTrue,
        reason:
            'hasCliState must see the copied transcript via the persisted '
