...
void main() {
  ...
  group('reconnect personal tab', () {
    test(
      'failed personal reconnect fails the session-plane callback',
      () async {
    ...
    test(
      'reconnect finishes remaining personal tabs then throws first error',
      () async {
        TestWidgetsFlutterBinding.ensureInitialized();
        ...
        final connector = _SelectiveFailingShellConnector(
          host,
          failSessionIds: {'sess-1'},
        );
        final reconnect = SessionSshProfileReconnect(
          host: host,
